...
export const openAiTools = [
  exportZipTool,
  {
    ...
    function: {
      ...
      description: 'Generate or edit one still. The runtime prefers the configured and tested Volcengine Ark Seedream 5.0 Pro provider for this generic image tool, and falls back to GPT Image via fal only when Ark is unavailable. Call once per image. For several images, call it several times in the SAME turn. To edit, pass input_urls (uploaded stills, previous results, or "latest"). Omit input_urls for text-to-image.',
      parameters: {
        type: 'object',
