...
const answer = { questionId: 'layer_selection_method', optionId: 'draw_boxes', imageUrl: 'https://example.com/source.png', regions: [[10, 20, 300, 400], [500, 500, 900, 900]], boxedImageUrl: 'http://localhost:3001/media/boxes.png' }
...
test('HTTP parser preserves source and bbox through choice validation and model selection', () => {
  ...
  assert.deepEqual(selection, { imageUrl: answer.imageUrl, regions: answer.regions, boxedImageUrl: answer.boxedImageUrl })
})
